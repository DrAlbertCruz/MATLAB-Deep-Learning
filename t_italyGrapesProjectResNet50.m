function t_italyGrapesProjectResNet50( PARAM_LIMIT_IN )
clc
DATA_LOCATION = 'G:\data\Vitis-Vinifera-Data-2017\localized';
...
for PARAM_LIMIT = PARAM_LIMIT_IN
    ...
    save( [ 't_resnet_epochVal' num2str(PARAM_LIMIT) '.mat'], 'results' );
    t_mailtest( [ 'VICTORY JOB SCHEDULER: ResNet50 done with epoch ' num2str( PARAM_LIMT ) ] );
end
