...
pool = parpool(3);
F1 = parfeval( pool, @retrainDeepLearner, 0, 1:40, '~/data/Salento-Grapevine-Yellows-Dataset/raw', '/home/acruz/MATLAB-Deep-Learning/Salento3', 'InceptionResnetV2_e', @retrainInceptionResnetV2, 299 );
...
F7 = parfeval( pool, @retrainDeepLearner, 0, 1:40, '~/data/Salento-Grapevine-Yellows-Dataset/localized', '/home/acruz/MATLAB-Deep-Learning/localized', 'InceptionResnetV2_e', @retrainInceptionResnetV2, 299 );
