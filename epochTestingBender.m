...
% they take up
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'squeezenet_frozen_e1', 'squeezenet', FOLDS, 1, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'squeezenet_frozen_e2', 'squeezenet', FOLDS, 2, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'squeezenet_frozen_e3', 'squeezenet', FOLDS, 3, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'squeezenet_frozen_e4', 'squeezenet', FOLDS, 4, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'squeezenet_frozen_e5', 'squeezenet', FOLDS, 5, true );

crossValidate( DATA_LOCATION, SAVE_LOCATION, 'inceptionv3_frozen_e1', 'inceptionv3', FOLDS, 1, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'inceptionv3_frozen_e2', 'inceptionv3', FOLDS, 2, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'inceptionv3_frozen_e3', 'inceptionv3', FOLDS, 3, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'inceptionv3_frozen_e4', 'inceptionv3', FOLDS, 4, true );
crossValidate( DATA_LOCATION, SAVE_LOCATION, 'inceptionv3_frozen_e5', 'inceptionv3', FOLDS, 5, true );
